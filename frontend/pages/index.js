...
export default function Home() {
  ...
  const addCar = async event => {
    ...
    const res = await fetch('https://venti.pi.jokley.at//api/cars', {
      body: JSON.stringify({
  ...
  const editCar = async event => {
    ...
    const res = await fetch(`https://venti.pi.jokley.at//api/cars/${carId}`, {
      body: JSON.stringify({
        name: 'test_name',
        model:'test_model',
        doors: '11',
  ...
  const url = (`https://venti.pi.jokley.at//api/cars`);
