...
CREATE TABLE sensor_calibrations(id text primary key,sensor_id text,version text,model text,points text,slope real,offset real,active boolean,created_at text);
